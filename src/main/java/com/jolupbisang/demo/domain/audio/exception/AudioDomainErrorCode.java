...
public enum AudioDomainErrorCode implements ErrorCode {
    INVALID_USER_ID("AD-0001", HttpStatus.BAD_REQUEST, "사용자 ID는 0보다 크거나 같아야 합니다."),
    ...
    FUTURE_CREATED_DATE_TIME("AD-0004", HttpStatus.BAD_REQUEST, "생성 시간은 현재 시간보다 뒤에 있을 수 없습니다."),
