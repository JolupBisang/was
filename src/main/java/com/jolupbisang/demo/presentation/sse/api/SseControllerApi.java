package com.jolupbisang.demo.presentation.sse.api;
...
public interface SseControllerApi {
    ...
    SseEmitter subscribeParticipationRate(
            @Parameter(description = "회의 ID", required = true, example = "1")
    ...
    SseEmitter subscribeFeedback(@Parameter(description = "회의 ID", required = true, example = "1")
                                 @PathVariable Long meetingId,
                                 @AuthenticationPrincipal CustomUserDetails userDetails);
}
